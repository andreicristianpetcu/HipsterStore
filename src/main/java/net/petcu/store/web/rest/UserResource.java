...
import java.util.*;
import net.petcu.store.config.Constants;
import net.petcu.store.domain.User;
import net.petcu.store.repository.UserRepository;
import net.petcu.store.security.AuthoritiesConstants;
import net.petcu.store.service.MailService;
import net.petcu.store.service.UserService;
import net.petcu.store.service.dto.AdminUserDTO;
import net.petcu.store.web.rest.errors.BadRequestAlertException;
import net.petcu.store.web.rest.errors.EmailAlreadyUsedException;
import net.petcu.store.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link net.petcu.store.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
