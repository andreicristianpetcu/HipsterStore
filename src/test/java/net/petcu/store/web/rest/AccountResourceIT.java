...
import net.petcu.store.repository.AuthorityRepository;
...
import net.petcu.store.service.dto.PasswordChangeDTO;
import net.petcu.store.web.rest.vm.KeyAndPasswordVM;
import net.petcu.store.web.rest.vm.ManagedUserVM;
