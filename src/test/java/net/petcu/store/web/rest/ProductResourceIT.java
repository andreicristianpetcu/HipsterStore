...
import static net.petcu.store.domain.ProductAsserts.*;
...
import net.petcu.store.service.mapper.ProductMapper;
...
class ProductResourceIT {
    ...
    public static Product createEntity() {
        return new Product().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
    }
    ...
    public static Product createUpdatedEntity() {
        return new Product().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    }
