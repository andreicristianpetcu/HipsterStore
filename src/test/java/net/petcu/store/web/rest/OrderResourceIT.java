...
import static net.petcu.store.domain.OrderAsserts.*;
...
class OrderResourceIT {
    ...
    public static Order createEntity() {
        return new Order().date(DEFAULT_DATE).subtotal(DEFAULT_SUBTOTAL).finalPrice(DEFAULT_FINAL_PRICE).status(DEFAULT_STATUS);
    }
    ...
    public static Order createUpdatedEntity() {
        return new Order().date(UPDATED_DATE).subtotal(UPDATED_SUBTOTAL).finalPrice(UPDATED_FINAL_PRICE).status(UPDATED_STATUS);
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.date(UPDATED_DATE).subtotal(UPDATED_SUBTOTAL).finalPrice(UPDATED_FINAL_PRICE).status(UPDATED_STATUS);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.subtotal(UPDATED_SUBTOTAL).finalPrice(UPDATED_FINAL_PRICE);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.date(UPDATED_DATE).subtotal(UPDATED_SUBTOTAL).finalPrice(UPDATED_FINAL_PRICE).status(UPDATED_STATUS);
